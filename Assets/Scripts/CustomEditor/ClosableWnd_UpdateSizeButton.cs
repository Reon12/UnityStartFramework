...
public class ClosableWnd_UpdateSizeButton : Editor
{
    public override void OnInspectorGUI()
    {
        ...
        {
            // 타이틀 바 얻기
            var titleBar = closableWndComponent.GetComponentInChildren<ClosableWndTitlebar>();

            // 컨텐츠 패널 얻기
            RectTransform panel_Content = closableWndComponent.transform.Find("Panel_Content").transform as RectTransform;
